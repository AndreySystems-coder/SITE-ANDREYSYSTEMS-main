...
const translations = {
  pt: {
    ...
    founderText1: "Desenvolvedor do ERP IMPPEL e do projeto EntreosSalvos. Crio sites, sistemas e automações para empresas que querem sair do improviso e organizar processos com tecnologia.",
    founderText2: "Minha missão é transformar rotinas manuais em soluções digitais claras, ajudando pequenos negócios a ganhar presença, controle e confiança para crescer.",
    ...
    feedbackTitle: "Feedbacks discretos, sem promessas irreais.",
    feedbackText: "Textos temporários para representar o tipo de retorno esperado. Devem ser substituídos por depoimentos reais quando houver autorização.",
  ...
  en: {
    ...
    founderText1: "Developer of ERP IMPPEL and EntreosSalvos. I build websites, systems and automations for companies that want to stop improvising and organize processes with technology.",
    founderText2: "My mission is to turn manual routines into clear digital solutions, helping small businesses gain presence, control and confidence to grow.",
    ...
    feedbackTitle: "Discreet feedback, without unrealistic promises.",
    feedbackText: "Temporary copy representing the type of feedback expected. Replace with real authorized testimonials later.",
